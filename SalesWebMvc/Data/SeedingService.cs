...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        // Construtor que recebe o contexto do banco de dados (Injeção de Dependência)
        ...
        public void Seed()
        {
            // Verifica se já existe qualquer dado cadastrado no banco. 
            // Se já existirem dados, ele para a execução aqui para não duplicar nada.
            if (_context.Department.Any() ||
                _context.Seller.Any() ||
                _context.SalesRecord.Any())
            {
                return; // DB has been seeded (O banco já foi populado)
            }
            ...
            // --- INSTANCIANDO OS VENDEDORES (SELLERS) ---
            ...
            // --- INSTANCIANDO OS REGISTROS DE VENDAS (SALESRECORDS) ---
            ...
            // --- ADICIONANDO OS DADOS NA FILA DO ENTITY FRAMEWORK ---
            ...
            // --- SALVANDO TUDO DE FATO NO BANCO DE DADOS MYSQL ---
